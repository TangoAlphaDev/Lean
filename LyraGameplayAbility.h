...
public:
	...
	// @TangoAlphaDev
	// Sets the secondary ability camera mode.
	UFUNCTION(BlueprintCallable, Category = "Lyra|Ability")
	void SetSecondaryCameraMode(TSubclassOf<ULyraCameraMode> CameraMode);

	// Clears the secondary ability camera mode. Automatically called if needed when the ability ends.
	UFUNCTION(BlueprintCallable, Category = "Lyra|Ability")
	void ClearSecondaryCameraMode();
	// @TangoAlphaDev
